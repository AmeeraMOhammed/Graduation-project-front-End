...
model = CustomCNN()
model.load_state_dict(torch.load("C:\\Users\\Dell\\Desktop\\facialparalysis\\faciafix\\accounts\\epoch10_eyebrows.pt", map_location=torch.device('cpu')))
model.to(device)
model.eval()
...
def predict_image_eyebrow(image_path):
